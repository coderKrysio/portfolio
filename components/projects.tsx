...
export const Projects = () => {
    return (
        ...
        >
            ...
            <div className="absolute left-[50px] top-[-40%] ml-[25px] flex flex-col justify-between gap-[30px] opacity-30">
                <Shell
                    width={"50px"}
                    height={"50px"}
                    strokeWidth={1}
            ...
            <div className="absolute left-[30%] bottom-[-230px] opacity-65 z-[1]">
                <AttentionSeeker effect="flash" cascade damping={0.25}>
                    <ChevronsDown width={230} height={230} color="#FBB95D" />
                    <ChevronsDown
                        width={230}
                        height={230}
                        color="#FBB95D"
